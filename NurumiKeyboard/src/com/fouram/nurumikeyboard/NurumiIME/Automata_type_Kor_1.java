...
public class Automata_type_Kor_1 extends IME_Automata {
  ...
  private final int[] PREF_CHO = {12593, 12594, 12596, 12599, 12600, 12601, 12609, 12610,
      12611, 12613, 12614, 12615, 12616, 12617, 12618, 12619, 12620, 12621, 12622};
  // た だ ち ぢ っ つ づ て で と ど な に ぬ ね の は ば ぱ ひ び
  //private final int[] PREF_JUNG = {12623, 12624, 12625, 12626, 12627, 12628, 12629, 12630,
  ...
  //private final int[] PREF_JONG = {12593, 12594, 12595, 12596, 12597, 12598, 12599, 12601,
  //    12602, 12603, 12604, 12605, 12606, 12607, 12608, 12609, 12610, 12612, 12613, 12614, 12615,
  //    12616, 12618, 12619, 12620, 12621, 12622};
  private final int AC00 = 44032;

  private final int area_a=12685;
  private final int ssangarea_a=4514;

  private final int THUMB_FINGER = 0;
  private final int INDEX_FINGER = 1;
  private final int MIDLE_FINGER = 2;
  private final int RING__FINGER = 3;
  private final int PINKY_FINGER = 4;

  private final int DIRECTION_EMPTY = -1;
  private final int DIRECTION_DOT = 0;
  ...
  private int count_finger = 0;
  private String str_to_write = null;
  private int[] finger;
    ...
    switch (count_finger) { // kim // step 2. switch by finger counts for accuracy
        ...
        case 2: // kim // 150413 // case for two fingers
            ...
            if (finger[MIDLE_FINGER] == DIRECTION_DOT&&finger[RING__FINGER] == DIRECTION_DOT) {
                ...
                str_to_write = String.format("%c", 12641);//'ぱ'
        ...
        case 3:// kim // 150413 // case for three fingers
            ...
            if (finger[INDEX_FINGER] == DIRECTION_DOT&&finger[MIDLE_FINGER] == DIRECTION_DOT
                ...
                str_to_write = String.format("%c", 12643);//'び'
...
if(checkmoeumcomplete!=true)
{
  ...
  protected String execute(int[] finger_array, InputConnection input_connection) {
    ...
    if (ENABLE_DEBUG == true) { // kim // 150413 // for debug
