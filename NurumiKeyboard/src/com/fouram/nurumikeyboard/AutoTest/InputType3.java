...
public class InputType3 extends MotionInput {


	public InputType3(InputConnection ic) {
		super(ic);
	...
	public void dbSeeot() {
		// TODO Auto-generated method stub
		ic.commitText(String.valueOf(automata.execute(new int[] {0,-1,0,0,0},ic)),1);
		/*
		str = automata.execute(new int[] {0,-1,0,0,0},ic);
		Log.i("TestResult", "TestResult : " + str);
		*/
	}
	...
	public void eu() {
		// TODO Auto-generated method stub
		ic.commitText(String.valueOf(automata.execute(new int[] {-1,D_RIGHT,D_RIGHT,D_RIGHT,D_RIGHT},ic)),1);
		/*
		str = automata.execute(new int[] {-1,D_RIGHT,D_RIGHT,D_RIGHT,D_RIGHT},ic);
		Log.i("TestResult", "TestResult : " + str);
		*/
	}
	...
	public void yeh() {
		// TODO Auto-generated method stub
		ic.commitText(String.valueOf(automata.execute(new int[] {-1,2,2,2,-1},ic)),1);
		/*
		str = automata.execute(new int[] {-1,2,2,2,-1},ic);
		Log.i("TestResult", "TestResult : " + str);
		*/
	}
	public void wa() {
		// TODO Auto-generated method stub
		ic.commitText(String.valueOf(automata.execute(new int[] {-1,D_UP,-1,-1,-1},ic)),1);
		ic.commitText(String.valueOf(automata.execute(new int[] {-1,4,-1,-1,-1},ic)),1);
		/*
		str = automata.execute(new int[] {-1,D_UP,-1,-1,-1},ic);
		str = automata.execute(new int[] {-1,4,-1,-1,-1},ic);
		Log.i("TestResult", "TestResult : " + str);
		*/
	}
	public void wae() {
		...
		ic.commitText(String.valueOf(automata.execute(new int[] {-1,4,-1,4,-1},ic)),1);
		/*
		str = automata.execute(new int[] {-1,3,-1,-1,-1},ic);
		str = automata.execute(new int[] {-1,4,-1,4,-1},ic);
		Log.i("TestResult", "TestResult : " + str);
		*/
	}
	public void woe() {
	...
	public void wuh() {
		// TODO Auto-generated method stub
		ic.commitText(String.valueOf(automata.execute(new int[] {-1,D_DOWN,-1,-1,-1},ic)),1);
		ic.commitText(String.valueOf(automata.execute(new int[] {-1,2,-1,-1,-1},ic)),1);
		/*
		str = automata.execute(new int[] {-1,D_DOWN,-1,-1,-1},ic);
		str = automata.execute(new int[] {-1,2,-1,-1,-1},ic);
		Log.i("TestResult", "TestResult : " + str);
		*/
	}
	public void weh() {
		// TODO Auto-generated method stub
		ic.commitText(String.valueOf(automata.execute(new int[] {-1,1,-1,-1,-1},ic)),1);
		ic.commitText(String.valueOf(automata.execute(new int[] {-1,2,-1,2,-1},ic)),1);
		/*
		str = automata.execute(new int[] {-1,1,-1,-1,-1},ic);
		str = automata.execute(new int[] {-1,2,-1,2,-1},ic);
		Log.i("TestResult", "TestResult : " + str);
		*/
	}
	public void wui() {
	...
	public void ui() {
		// TODO Auto-generated method stub
		ic.commitText(String.valueOf(automata.execute(new int[] {-1,4,4,4,4},ic)),1);
		ic.commitText(String.valueOf(automata.execute(new int[] {-1,1,1,1,1},ic)),1);
		/*
		str = automata.execute(new int[] {-1,4,4,4,4},ic);
		str = automata.execute(new int[] {-1,1,1,1,1},ic);
		Log.i("TestResult", "TestResult : " + str);
		*/
	}
